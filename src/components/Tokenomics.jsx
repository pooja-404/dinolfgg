...
import TokenomicsCartoon from "../assets/images/cartoont.webp";
import CartoonCircle from "../assets/images/tokecircle.webp";
import CartoonBottomImg from "../assets/images/CartoonBottomImg.webp";
import TokenomicsChart from "../assets/images/TokenomicsChart.webp";
import TreeLayer from "../assets/images/TreeLayer.webp";
import TokenomicsVector from "../assets/images/TokenomicsVector.webp";
import TokenomicsTreeImg from "../assets/images/TokenomicsTreeImg.webp";
import TokenomicsCartoon2 from "../assets/images/TokenomicsCartoon2.webp";
                ...
                <div className="container relative z-[1] xl:max-w-[1147px] xl:px-3 px-6 mx-auto sm:pt-[236px] pt-[80px] xl:pb-[540px] lg:pb-[400px] sm:pb-[350px] pb-[175px]">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="relative xl:max-w-[589.84px] lg:max-w-[515px] sm:max-w-[430px] max-w-[320px]">
                            ...
                            />
                            <div
                                className="lg:flex hidden absolute xl:top-[12%] top-[41%] xl:left-[-45%] lg:left-[-46%] left-[-40%] lg:gap-[26.11px] gap-[15px]"
                                data-aos="zoom-in"
                            >
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#FBA11D] font-bal leading-[119%] lg:text-[32px] text-[23px] font-normal">
                                        333,333,333
                                    </p>
                                    <p className="text-white leading-[138%] font-normal text-[24px] text-right font-bal">
                                        Supply
                                    </p>
                                </div>
                            ...
                            <div
                                className="lg:flex hidden absolute xl:top-[12%] top-[43%] xl:right-[-50%] lg:right-[-52%] right-[-48%] lg:gap-[26.11px] gap-[15px]"
                                data-aos="zoom-in"
                            >
                                <div className="border border-solid border-white border-l-0 border-b-0 h-[88px] w-[16px]"></div>
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#8EC627] lg:max-w-[217px] max-w-[164px] leading-[119%] lg:text-[32px] text-[23px] font-normal font-bal">
                                        Liquidity lock for 1 year
                                    </p>
                                </div>
                            </div>
                            <div
                                className="lg:flex hidden absolute xl:bottom-[-45%] bottom-[-28%] xl:left-[42%] left-[38%] justify-center items-center flex-col gap-[17px]"
                                data-aos="zoom-in"
                            >
                                <div className="bg-white h-[43px] w-[1px]"></div>
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#D45B07] max-w-[217px] leading-[119%] text-[32px] font-normal font-bal">
                                        No Tax
                                    </p>
                                </div>
                            </div>
                            <div
                                className="lg:flex hidden absolute xl:bottom-[-27%] bottom-[-17%] left-[-27%] justify-center items-center gap-[17px]"
                                data-aos="zoom-in"
                            >
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#23AAAC] max-w-[217px] leading-[119%] lg:text-[32px] text-[23px] font-normal font-bal">
                                        95% Uniswa
                                    </p>
                                    <p className="text-[#23AAAC] font-bal max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px] font-normal">
                                        5% Marketing
                                    </p>
                                    <p className="text-white max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px]  font-normal font-bal">
                                        Allocation
                                    </p>
                                </div>
                            ...
                            <div
                                className="lg:flex hidden absolute xl:bottom-[-23%] bottom-[-18%] right-[-31%] justify-center items-center gap-[17px]"
                                data-aos="zoom-in"
                            >
                                <div className="border-white border border-solid h-[102px] w-[16px] border-b-0 border-l-0 skew-y-[52deg] "></div>
                                <p className="text-[#FB5352] leading-[119%] lg:text-[32px] text-[23px] font-normal font-bal">
                                    No Mint Function
                                </p>
                            </div>
                            <div
                                ...
                                <div className=" flex flex-col md:gap-[35px] ">
                                    <div className="flex gap-[32px] max-md:pt-5">
                                        ...
                                        <div className="flex flex-col gap-[5px]">
                                            ...
                                            <p className="text-white leading-[138%] font-normal sm:text-[24px] text-[20px] font-bal">
                                                Supply
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex gap-[32px] max-md:pt-5">
                                        ...
                                        <div className="flex flex-col gap-[5px]">
                                            ...
                                            <p className="text-white leading-[138%] sm:text-[32px] text-[24px] font-normal font-bal">
                                                Allocation
                                            </p>
                                        </div>
                                    </div>
